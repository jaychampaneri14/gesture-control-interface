...
> Control computer with hand gestures using MediaPipe
...
```bash
git clone https://github.com/jaychampaneri14/gesture-control-interface.git
...
Main libraries: Computer Vision, Python, Mediapipe
